...
import { catalogSearch } from '../../constants/routes'
...
const items: FrequentItem[] = [
  {
    label: 'Снять комнату',
    href: catalogSearch({ category: 'residential', propertyType: 'room' }),
    icon: (
  ...
  },
  {
    ...
    href: catalogSearch({ category: 'residential', propertyType: 'apartment' }),
    icon: (
      <svg width="32" height="32" viewBox="0 0 24 24" fill="none" aria-hidden="true">
        <path
          d="M3 10.5L12 3l9 7.5V20a1.5 1.5 0 01-1.5 1.5H5.5A1.5 1.5 0 014 20V10.5z"
          stroke="currentColor"
          strokeWidth="1.5"
